...
from rackad.lib import RackSize, panel_height, panel_width, panel_thickness, panel_fillet
...
class PanelFlat(Part):
    ...
    def build(self):
        return cq.Workplane("XY").box(self.width, self.height, panel_thickness).edges("|Z").fillet(panel_fillet)
